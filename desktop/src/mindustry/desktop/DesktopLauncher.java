...
public class DesktopLauncher extends ClientLauncher{
    public final static long discordID = 1498730491992477897L;
    ...
    public static void main(String[] arg){
        try{
            ...
            new SdlApplication(new DesktopLauncher(arg), new SdlConfig(){{
                ...
                setWindowIcon(FileType.internal, "icons/router.png");
            }});
        }catch(Throwable e){
            handleCrash(e);
        }
    ...
    static void checkJavaVersion(){
        if(OS.javaVersionNumber < 17){
            ...
            ErrorDialog.show("Java 17-25 is required to run Mindustry. Your version: " + OS.javaVersionNumber + "\n" +
            "\n" +
        ...
        if(useDiscord){
            Threads.daemon(() -> {
                try{
                    ...
                    useDiscord = false;
                    Log.warn("Failed to initialize Discord RPC.");
                }
            });
