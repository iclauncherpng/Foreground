...
public class CoreBlock extends StorageBlock{
    ...
    public boolean landSpawn = false;
    ...
    public boolean canPlaceOn(Tile tile, Team team, int rotation){
        ...
        if(state.rules.canBuildCores || state.isEditor()) return true;
        ...
        return tile.block() instanceof mindustry.world.blocks.storage.CoreBlock && size > tile.block().size;
    }
