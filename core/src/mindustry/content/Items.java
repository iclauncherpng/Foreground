...
public class Items{
    ...
    beryllium, tungsten, oxide, carbide, fissileMatter, dormantCyst, aluminum, sulfur;
    ...
    public static void load(){
        ...
        aluminum = new Item("aluminum", Color.valueOf("a3a3a3")){{
            hardness = 2;
            flammability = 0f;
        }};

        sulfur = new Item("sulfur", Color.valueOf("e8c56b")){{
            hardness = 2;
            flammability = 0f;
        }};
