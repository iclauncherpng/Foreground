...
public class Planets{
    ...
    public static void load(){
        sun = new Planet("sun", null, 4f){{
            ...
            accessible = true;
            alwaysUnlocked = true;
            iconColor = Color.valueOf("ff7a38");
        ...
        tantros = new Planet("tantros", sun, 1f){{
            ...
            defaultCore = TantrosBlocks.evacuationCapsule;
            allowLaunchToNumbered = false;
            atmosphereRadOut = 0.3f;
            defaultEnv = Env.underwater | Env.terrestrial;
            ruleSetter = r -> {
                r.waveTeam = Team.forerunners;
        ...
        tirius = new Planet("tirius", tantros, 0.2f){{
            generator = new TantrosMoonGenerator();
            meshLoader = () -> new HexMesh(this, 5);
            orbitRadius = 7f;
            orbitTime = 15700f;
            accessible = false;
            alwaysUnlocked = true;
            iconColor = Color.valueOf("3d3d3d");
        ...
        redGiant = new Planet("redGiant", null, 280f){{
            bloom = true;
            accessible = false;
            alwaysUnlocked = true;
            iconColor = Color.valueOf("ff3300");

            meshLoader = () -> new SunMesh(
                    this, 6,
                    5, 0.3, 1.7, 1.2, 1,
                    1.1f,
                    Color.valueOf("1a0000"),
                    Color.valueOf("330000"),
                    Color.valueOf("550000"),
                    Color.valueOf("880000"),
                    Color.valueOf("aa0000"),
                    Color.valueOf("cc0000"),
                    Color.valueOf("ff3300"),
                    Color.valueOf("ff6a00"),
                    Color.valueOf("ff9900"),
                    Color.valueOf("ffcc66"),
                    Color.valueOf("ffeeb3")
            );

            hasAtmosphere = true;
            atmosphereRadIn = 0.01f;
            atmosphereRadOut = 3.8f;
            atmosphereColor = Color.valueOf("ff3300").a(0.6f);
            rotateTime = 10f;
            drawOrbit = false;
        }};

        exPlanet = new Planet("exPlanet", redGiant, 1f){{
            generator = new exPlanetGenerator();
            meshLoader = () -> new HexMesh(this, 6);
            cloudMeshLoader = () -> new MultiMesh(
                    new HexSkyMesh(this, 2, 0.1f, 0.12f, 5, Color.valueOf("111111").a(0.85f), 2, 0.55f, 0.9f, 0.45f),
                    new HexSkyMesh(this, 3, 0.13f, 0.15f, 5, Color.valueOf("222222").a(0.8f), 3, 0.48f, 1.1f, 0.48f)
            );
            orbitRadius = 1400f;
            orbitTime = 345700f;
            launchCapacityMultiplier = 0.5f;
            ...
            showRtsAIRule = true;
            iconColor = Color.valueOf("5e5e5e");
            atmosphereColor = Color.valueOf("222222");
            atmosphereRadIn = 0.03f;
            atmosphereRadOut = 0.35f;
            startSector = 10;
            alwaysUnlocked = true;
            allowSelfSectorLaunch = true;
            landCloudColor = Color.black.cpy().a(0.5f);
        }};

        exMoon = new Planet("exMoon", exPlanet, 0.4f){{
            generator = new exMoonGenerator();
            meshLoader = () -> new HexMesh(this, 5);
            orbitRadius = 7f;
            orbitTime = 15700f;
            accessible = false;
