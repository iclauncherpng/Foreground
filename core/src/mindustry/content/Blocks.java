...
import mindustry.world.blocks.neoplasm.*;
...
public class Blocks{
    ...
    //environment
    air, spawn, removeWall, removeOre, cliff, deepwater, water, taintedWater, deepTaintedWater, tar, slag, cryofluid, neoplasm, stone, craters, charr, sand, darksand, dirt, mud, ice, snow, darksandTaintedWater, space, empty,
    ...
    //new metal floors
    metalTiles1, metalTiles2, metalTiles3, metalTiles4, metalTiles5, metalTiles6, metalTiles7, metalTiles8, metalTiles9, metalTiles10, metalTiles11, metalTiles12, metalTiles13, metalTiles14, metalTiles15,
    //new metal walls
    ...
    //ores
    oreCopper, oreLead, oreScrap, oreCoal, oreTitanium, oreThorium, oreAluminum,
    ...
    //sandbox
    powerSource, powerVoid, itemSource, itemVoid, liquidSource, liquidVoid, payloadSource, payloadVoid, illuminator, heatSource, sandboxStorage,
    ...
    surgeConveyor, surgeRouter, phaseDuct,
    ...
    //neoplasm
    neoplasticHeart, neoplasticTendril,
    ...
    public static void load(){
        ...
        neoplasm = new Floor("pooled-neoplasm"){{
            ...
            liquidMultiplier = 0.5f;
            isLiquid = true;
            cacheLayer = CacheLayer.neoplasm;
        ...
        metalTiles14 = new Floor("metal-tiles-14"){{
            autotile = true;
            drawEdgeOut = false;
            drawEdgeIn = false;
        }};

        metalTiles15 = new Floor("metal-tiles-15"){{
            autotile = true;
            drawEdgeOut = false;
            drawEdgeIn = false;
        }};
        ...
        oreAluminum = new OreBlock(Items.aluminum);
        ...
        phaseDuct = new ItemBridge("phase-duct"){{
            requirements(Category.distribution, with(Items.phaseFabric, 5, Items.tungsten, 7, Items.beryllium, 10, Items.graphite, 10));
            range = 16;
            transportTime = 10f;
            arrowPeriod = 0.4f;
            arrowTimeScl = 5.75f;
        ...
        resonanceReactor = new ResonanceReactor("resonance-reactor"){{
            requirements(Category.experiments, with(Items.lead, 450, Items.silicon, 300, Items.graphite, 300, Items.thorium, 250, Items.surgeAlloy, 50));
            ...
            resonanceSpeed = 0.0003f;
            stabilityFall = 0.003f;
            stabilityRestore = 0.0005f;
            ...
            consumeItem(Items.thorium);
            consumeLiquid(Liquids.cryofluid, (heating * 4f) / coolantPower).update(false);
        }};
...
//            }}
        ...
        sandboxStorage = new StorageBlock("sandbox-storage"){{
        ...
        tradeConveyor = new TradeConveyor("trade-conveyor"){{
            requirements(Category.distribution, with(Items.graphite, 10, Items.titanium, 5));
            buildVisibility = BuildVisibility.diplomacyOnly;
            health = 60;
            speed = 0.04f;
            itemCapacity = 5;
...
//        neoplasticTendril = new NeoplasticTendril("neoplastic-tendril"){{
//            health = 500;
//            category = Category.defense;
//        }};
//
//        neoplasticHeart = new NeoplasticHeart("neoplastic-heart"){{
//            health = 10000;
//            category = Category.defense;
//            tendrilBlock = neoplasticTendril;
//        }};
    }
}
