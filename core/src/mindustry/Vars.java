...
public class Vars implements Loadable{
    ...
    public static final String minModGameVersion = "1.0.0";
    /** Min game version for java mods specifically - this is higher, as Java mods have more breaking changes. */
    public static final String minJavaModGameVersion = "1.0.0";
    ...
    public static boolean forceBeServers = true;
    ...
    /** If true, the mods will not be loaded. */
    ...
    public static final String appName = (Version.modifier.contains("canary") || Version.modifier.contains("indev"))
            ? "ForegroundCanary"
            : "Foreground";
    /** Github API URL. */
    ...
    public static final String discordndURL = "https://discord.gg/bVmrGnPqzV";
    ...
    public static final String[] serverJsonBeURLs = {"http://127.0.0.1:3000/foreground/MindustryServers/raw/branch/main/servers_be.json", "http://192.168.31.86:3000/foreground/MindustryServers/raw/branch/main/servers_be.json"};
    /** URLs to the JSON file containing all the stable servers.  */
    public static final String[] serverJsonURLs = {"http://127.0.0.1:3000/im1057inn/NewdustryServers/raw/branch/main/servers_v8.json", "http://192.168.31.86:3000/im1057inn/NewdustryServers/raw/branch/main/servers_v8.json"};
    /** URLs to the JSON files containing the list of mods.  */
    public static final String[] modJsonURLs = {"http://192.168.31.86:3000/Foreground/MindustryMods/raw/branch/v8/mods.json", "http://127.0.0.1:3000/Foreground/MindustryMods/raw/branch/v8/mods.json"};
    ...
    private static String getWorkingApi(){
        for(String url : ghApis){
            try{
                final boolean[] success = {false};
                Http.get(url + "/version")
                        .error(t -> {})
                        .submit(res -> success[0] = true);
                long start = System.currentTimeMillis();
                while(System.currentTimeMillis() - start < 300){
                    if(success[0]) return url;
                }
    ...
    public static GrayscaleFilter grayscale;
}
