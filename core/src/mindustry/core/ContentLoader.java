...
public class ContentLoader{
    ...
    public void createModContent(){
        if(mods != null && !Core.settings.getBool("disable_mods", false)){
            mods.loadContent();
        }
    }
    ...
    public void init(){
        ...
        for(mindustry.world.Block b : mindustry.Vars.content.blocks()){
            if(b instanceof mindustry.world.blocks.environment.Floor){
                b.category = mindustry.type.Category.terrain;
                b.inEditor = true;
            }
            else if(b instanceof mindustry.world.blocks.environment.StaticWall){
                b.category = mindustry.type.Category.stone;
                b.inEditor = true;
            }
            else if(b instanceof mindustry.world.blocks.environment.OreBlock){
                b.category = mindustry.type.Category.terrain;
                b.inEditor = true;
            }
            ...
            else if(b instanceof mindustry.world.blocks.environment.TallBlock){
                b.category = mindustry.type.Category.stone;
                b.inEditor = true;
            }
        }
