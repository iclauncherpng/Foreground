    ...
    void rebuild(){
        ...
        if(!mobile){
            ...
            if(state.rules.diplomacy){
                cont.button("@diplomacy.button", Icon.defense, () -> new DiplomacyDialog().show()).width(dw).height(55).pad(5f);
                cont.row();
            }
            ...
            if(state.rules.diplomacy){
                cont.buttonRow("@diplomacy.button", Icon.defense, () -> new DiplomacyDialog().show());
            }
