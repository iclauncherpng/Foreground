...
public enum Achievement{
    ...
    public void complete(){
        ...
        Core.settings.put("ach-" + name(), true);
        Core.settings.forceSave();
        if(Vars.ui != null && Vars.ui.hudfrag != null){
            Vars.ui.hudfrag.showToast(Core.bundle.format("achievement.done") + ": " + Core.bundle.get("achievement." + name()));
        }
    }

    public boolean isAchieved(){
        return Core.settings.getBool("ach-" + name(), false);
    }
