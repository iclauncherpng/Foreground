...
import static mindustry.core.Version.isAtLeast;
...
public class Mods implements Loadable{
    ...
    private LoadedMod loadMod(Fi sourceFile, boolean overwrite, boolean initialize) throws Exception{
        ...
        try{
            ...
            if(
                ...
                isAtLeast(meta.minGameVersion) &&
                (meta.getMinMajor() >= Strings.parseInt(minJavaModGameVersion, 0) || headless) &&
                !skipModCode &&
                initialize
            ){
                if(ios){
    ...
    public static class LoadedMod implements Publishable, Disposable{
        ...
        public boolean isSupported(){
            ...
            return isAtLeast(meta.minGameVersion);
        }
        ...
        public boolean isOutdated() {
            String target = isJava() ? minJavaModGameVersion : minModGameVersion;

            return !isAtLeast(target);
        }
